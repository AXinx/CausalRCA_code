...
do
	...
	python train_all_services.py --indx=$i --atype='cpu-hog1_' --gamma=0.5 | tee -a $output11;
done;
...
do
	...
	python train_all_services.py --indx=$i --atype='cpu-hog1_' --gamma=0.75 | tee -a $output12;
done;
...
do
	...
	python train_all_services.py --indx=$i --atype='cpu-hog1_' --eta=100 | tee -a $output13;
done;
...
do
    ...
    python train_all_services.py --indx=$i --atype='cpu-hog1_' --eta=1000 | tee -a $output14;
done;
...
do
    ...
    python train_all_services.py --indx=$i --atype='memory-leak1_' --gamma=0.5 | tee -a $output1;
done;
...
do
    ...
    python train_all_services.py --indx=$i --atype='memory-leak1_' --gamma=0.75 | tee -a $output2;
done;
...
do
    ...
    python train_all_services.py --indx=$i --atype='memory-leak1_' --eta=100 | tee -a $output3;
done;
...
do
    ...
    python train_all_services.py --indx=$i --atype='memory-leak1_' --eta=1000 | tee -a $output4;
done;
...
do
    ...
    python train_all_services.py --indx=$i --atype='latency1_' --gamma=0.5 | tee -a $output5;
done;
...
do
    ...
    python train_all_services.py --indx=$i --atype='latency1_' --gamma=0.75 | tee -a $output6;
done;
...
do
    ...
    python train_all_services.py --indx=$i --atype='latency1_' --eta=100 | tee -a $output7;
done;
...
do
    ...
    python train_all_services.py --indx=$i --atype='latency1_' --eta=1000 | tee -a $output8;
done;
